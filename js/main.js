$(function() {
    ...
    $('#watch-video').hover(
        function(){
            $('.background-video').find('.iframe-overlay').css('opacity','1');
            $('.logo-container').css('background-color','rgba(0,0,0,0.8)')
        }, function(){
            $('.background-video').find('.iframe-overlay').css('opacity','0.2');
            $('.logo-container').css('background-color','rgba(0,0,0,0)')
